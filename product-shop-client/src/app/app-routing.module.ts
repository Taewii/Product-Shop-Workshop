...
const appRoutes: Routes = [
  ...
  },
  {
    path: 'orders',
    children: [
      { path: 'all', component: AllOrdersComponent, canActivate: [AuthGuard], data: { role: 'Admin' } },
      { path: 'mine', component: MyOrdersComponent, canActivate: [AuthGuard], data: { role: 'User' } },
      { path: 'product/:id', component: CreateOrderComponent, canActivate: [AuthGuard], data: { role: 'User' } },
      { path: 'details/:id', component: OrderDetailsComponent, canActivate: [AuthGuard], data: { role: 'User' } }
    ]
  },
